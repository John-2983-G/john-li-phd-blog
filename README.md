...
This fork includes enhanced personalization features:

### 🎨 Custom Banner

- Customizable top banner with gradient backgrounds
...
- Smooth gradient underline animations on hover
- Professional CSS animations (like AMD website)
- Customizable colors and speeds
- Full dark/light theme support

**📚 Personalization Documentation:**

- **Getting Started:** [PERSONALIZATION_START_HERE.md](./PERSONALIZATION_START_HERE.md)
- **Quick Tutorial:** [QUICK_START.md](./QUICK_START.md)
- **Full Guide:** [CUSTOMIZATION_GUIDE.md](./CUSTOMIZATION_GUIDE.md)
- **Visual Effects:** [VISUAL_EFFECTS_GUIDE.md](./VISUAL_EFFECTS_GUIDE.md)
- **Documentation Index:** [DOCUMENTATION_INDEX.md](./DOCUMENTATION_INDEX.md)

[Learn how to customize your banner and navigation →](./PERSONALIZATION_START_HERE.md)
